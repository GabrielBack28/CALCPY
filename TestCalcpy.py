...
class TestCalcpy(unittest.TestCase):
    ...
    def test_is_value_valid(self):
        self.assertEqual(is_value_valid(float(0)), False)
        self.assertEqual(is_value_valid(float(1)), True)
        self.assertEqual(is_value_valid(float(250)), True)
        self.assertEqual(is_value_valid(float(-1)), False)
